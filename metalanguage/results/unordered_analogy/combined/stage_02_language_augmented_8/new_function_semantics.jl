# no new permanent functions -- language augmentation test (max AST size = 8)/n# temporary functions: 0
# no new permanent functions -- language augmentation test (max AST size = 8)/n# temporary functions: 2
...
# no new permanent functions -- language augmentation test (max AST size = 8)/n# temporary functions: 4
