# no new permanent functions -- language augmentation test (max AST size = 5)/n# temporary functions: 0
# no new permanent functions -- language augmentation test (max AST size = 5)/n# temporary functions: 0
# no new permanent functions -- language augmentation test (max AST size = 5)/n# temporary functions: 4
