# no new permanent functions -- language augmentation test (max AST size = 9)/n# temporary functions: 0
...
# no new permanent functions -- language augmentation test (max AST size = 9)/n# temporary functions: 4
